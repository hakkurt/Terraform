...
nsx_data_vars = {
  ...
  edge_cluster_name = "tf-EdgeCluster"    
...
vSphere = {
  ...
  K8s-node1-vm-ipv4_address = "10.190.16.51"
  K8s-node1-vm-ipv4_netmask = "24"
  K8s-node1-vm-ipv4_gateway = "10.190.16.1"
  K8s-node2-vm = "tf-K8s-node2"
  K8s-node2-vm-ipv4_address = "10.190.16.52"
  K8s-node2-vm-ipv4_netmask = "24"
  K8s-node2-vm-ipv4_gateway = "10.190.16.1"
